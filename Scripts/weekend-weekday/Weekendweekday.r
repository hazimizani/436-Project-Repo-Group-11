...
# crashes_all <- read.csv(paste0(fp, "dataset/NYC-CRASHES.csv")) %>% 
#   filter(year >= 2015)

crashes_all <- read_csv("dataset/NYC-Crashes.csv")

#boroughs_sf <- read.csv(paste0(fp, "/../Datasets/BOROUGHS-SF.csv"))
#raw = read.csv(paste0(fp, "/../Datasets/NYC-ACCIDENTS-SAMPLE.CSV"))
...
#borough_boundaries = read_csv(paste0(fp, "dataset/borough_boundaries.csv"), show_col_types = FALSE)
borough_boundaries <- read_csv("dataset/borough_boundaries.csv")
